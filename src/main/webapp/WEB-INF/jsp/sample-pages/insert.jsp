            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        ...
                        <form method="post" action="/UserController/toinsert">
                            <div class="card card-login card-hidden">
                                ...
                                <c:if test="${not empty smg}">
                                    <alert type="error" show-icon style="color: red">${smg}</alert>
                                </c:if>
                                <div class="content">
                                    ...
                                    <div class="form-group">
                                        <label>昵称</label>
                                        <input type="password" placeholder="name" name="username"
                                               class="form-control input-no-border">
                                    </div>
                                    </br>
                                    <div class="form-group">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-rose btn-wd btn-lg">注册账号</button>
                                    </br>
                                    </br>
                                    <p>
                                        <a href="/LoginContorller/login">
                                            <i class="ti-id-badge"></i> 登录账户
                                        </a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
