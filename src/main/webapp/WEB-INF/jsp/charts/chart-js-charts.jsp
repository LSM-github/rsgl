            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> ChartJS </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="header text-center">
                        <h3 class="title">ChartJS Charts</h3>
                        <p class="category">ChartJS is a simple yet flexible JavaScript charting library for designers & developers.
                            Please checkout their
                            <a href="http://www.chartjs.org/docs/" target="_blank">full documentation.</a>
                        </p>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Bar Line Combo Chart</h4>
                                </div>

                                <div class="content card-padding">
                                    <div class="chart chart-js-container">
                                        <canvas id="barlinecomboChart"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
