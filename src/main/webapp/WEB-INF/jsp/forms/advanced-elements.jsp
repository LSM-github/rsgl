					...
					<li class="active">
						...
						<div class="collapse" id="forms" role="navigation" aria-expanded="false" style="height: 0px;">
							<ul class="nav">
								...
								<li class="active"><a href="../forms/advanced-elements.html">Advanced Elements</a></li>
                            ...
                            <div class="card">
                                <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <legend>Tags</legend>
									<input name="tagsinput" class="tagsinput tag-success" value="Amsterdam,Washington,Sydney,Beijing" />
	                                <!-- You can change "tag-primary" with with "tag-info", "tag-success", "tag-warning","tag-danger" -->                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <legend>Drop Files (Dropzone.js)</legend>
											  <div id="dropzone">
